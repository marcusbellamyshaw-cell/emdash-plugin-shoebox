...
async function loadVirtualModules() {
	if (virtualConfig === void 0) virtualConfig = (await import("virtual:emdash/config")).default;
	if (virtualCreateDialect === void 0) virtualCreateDialect = (await import("virtual:emdash/dialect")).createDialect;
}
/**
...
//# sourceMappingURL=loader-Cs6-Bqe6.mjs.map