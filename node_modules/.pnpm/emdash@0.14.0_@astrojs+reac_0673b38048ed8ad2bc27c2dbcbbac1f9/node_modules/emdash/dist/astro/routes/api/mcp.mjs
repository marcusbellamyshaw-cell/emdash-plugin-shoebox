...
import { Sn as contentBylineInputSchema, sn as contentSeoInput } from "../../../redirects-Dmj6KRU3.mjs";
...
function createMcpServer() {
	...
	server.registerTool("content_get", {
		...
		requireScope(extra, "content:read");
		const result = await getEmDash(extra).handleContentGet(args.collection, args.id, args.locale);
	...
	server.registerTool("schema_list_collections", {
		...
		const ec = getEmDash(extra);
		try {
			const { SchemaRegistry } = await import("../../../schema-BmqagCwG.mjs").then((n) => n.t);
	...
	server.registerTool("search", {
		...
		const ec = getEmDash(extra);
		try {
			const { searchWithDb } = await import("../../../search-CPrvO5u8.mjs").then((n) => n.t);
	...
	server.registerTool("taxonomy_list", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTaxonomyList } = await import("../../../taxonomies-Dc0mzlms.mjs").then((n) => n.l);
	...
	server.registerTool("taxonomy_list_terms", {
		...
		try {
			...
			const { decodeCursor, encodeCursor, InvalidCursorError } = await import("../../../types-CwXMEPRr.mjs").then((n) => n.a);
	...
	server.registerTool("taxonomy_create_term", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermCreate } = await import("../../../taxonomies-Dc0mzlms.mjs").then((n) => n.l);
	...
	server.registerTool("taxonomy_update_term", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermUpdate } = await import("../../../taxonomies-Dc0mzlms.mjs").then((n) => n.l);
	...
	server.registerTool("taxonomy_delete_term", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermDelete } = await import("../../../taxonomies-Dc0mzlms.mjs").then((n) => n.l);
	...
	server.registerTool("taxonomy_term_translations", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermTranslations } = await import("../../../taxonomies-Dc0mzlms.mjs").then((n) => n.l);
	...
	server.registerTool("menu_list", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuList } = await import("../../../menus-DOzIecHi.mjs").then((n) => n.d);
	...
	server.registerTool("menu_get", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuGet } = await import("../../../menus-DOzIecHi.mjs").then((n) => n.d);
	...
	server.registerTool("menu_translations", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuTranslations } = await import("../../../menus-DOzIecHi.mjs").then((n) => n.d);
	...
	server.registerTool("menu_create", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuCreate } = await import("../../../menus-DOzIecHi.mjs").then((n) => n.d);
	...
	server.registerTool("menu_update", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuUpdate } = await import("../../../menus-DOzIecHi.mjs").then((n) => n.d);
	...
	server.registerTool("menu_delete", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuDelete } = await import("../../../menus-DOzIecHi.mjs").then((n) => n.d);
	...
	server.registerTool("menu_set_items", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuSetItems } = await import("../../../menus-DOzIecHi.mjs").then((n) => n.d);
	...
	server.registerTool("settings_get", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleSettingsGet } = await import("../../../settings-CBBj7HUd.mjs").then((n) => n.r);
	...
	server.registerTool("settings_update", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleSettingsUpdate } = await import("../../../settings-CBBj7HUd.mjs").then((n) => n.r);
