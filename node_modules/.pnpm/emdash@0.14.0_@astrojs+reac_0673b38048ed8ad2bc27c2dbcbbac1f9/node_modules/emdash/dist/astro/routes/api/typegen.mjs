...
async function generateTypes(registry) {
	const { generateTypesFile, generateSchemaHash } = await import("../../../zod-generator-DSyz01KE.mjs").then((n) => n.r);
