...
import { _ as after, d as PluginRouteRegistry, f as EmailPipeline, g as definePlugin, h as resolveExclusiveHooks, m as createHookPipeline } from "../menus-X4Z-eBA1.mjs";
import { r as RevisionRepository } from "../content-D6YG26WG.mjs";
...
import { t as FTSManager } from "../fts-manager-B633C-kQ.mjs";
import { n as SchemaRegistry } from "../registry-BnCeHYsf.mjs";
...
import { r as normalizeManifestRoute } from "../manifest-schema-HCtSh4Jq.mjs";
import "../types-Db67HHlU.mjs";
import "../ssrf-DzFN_qV-.mjs";
import "../error-tSQWIl5U.mjs";
import "../parse-BFTPon-J.mjs";
import "../redirects-Dmj6KRU3.mjs";
import "../setup-BGAJ2uXs.mjs";
import { a as invalidateUrlPatternCache } from "../query-axZmO6Tn.mjs";
import "../import-CNfLOgDE.mjs";
import { t as getTrustedProxyHeaders } from "../trusted-proxy-CJhQIk65.mjs";
import { n as sanitizeHeadersForSandbox, t as extractRequestMeta } from "../request-meta-CLCwSQOS.mjs";
import "../ssrf-CTul4uQi.mjs";
import { n as CronExecutor } from "../cron-H8eJ46dv.mjs";
import { r as devConsoleEmailDeliver, t as DEV_CONSOLE_EMAIL_PLUGIN_ID } from "../email-console-Dmp5Q-P2.mjs";
import "../utils-_F-rWBTN.mjs";
import "../tokens-DILYNZMi.mjs";
import "../preview-C1LOEbWZ.mjs";
import "../bylines-BTM2xtP8.mjs";
import "../widgets-B9j_yzlk.mjs";
import "../apply-v4DBgjPw.mjs";
...
var EmDashRuntime = class EmDashRuntime {
		...
		dbInitPromise = (async () => {
			...
			try {
				...
				if (collectionCount.count === 0 && !setupDone) {
					const { applySeed } = await import("../apply-v4DBgjPw.mjs").then((n) => n.n);
					const { loadSeed } = await import("../load-QzYRpVN3.mjs").then((n) => n.r);
					const { validateSeed } = await import("../validate-DlFxcVVK.mjs").then((n) => n.n);
	...
	*/
	...
	async handleContentCreate(collection, body) {
		...
		const { validateContentData } = await import("../validation-BiFJqUp5.mjs");
