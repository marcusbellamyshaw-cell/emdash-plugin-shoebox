...
declare function LayerCardSecondary({ children, className, }: LayerCardSectionProps): import("react/jsx-runtime").JSX.Element;
declare namespace LayerCardSecondary {
    var displayName: string;
}
declare function LayerCardPrimary({ children, className }: LayerCardSectionProps): import("react/jsx-runtime").JSX.Element;
