...
import { HighlightRange, CommandPaletteRootProps, CommandPaletteListProps, CommandPaletteGroupProps, CommandPaletteGroupLabelProps, CommandPaletteItemProps, CommandPaletteEmptyProps, CommandPaletteLoadingProps, CommandPaletteFooterProps, CommandPaletteResultItemProps } from './types';
/**
 ...
 */
declare function PanelInput({ autoFocus, placeholder, className, onKeyDown: onKeyDownProp, leading, trailing, ...props }: {
    autoFocus?: boolean;
    placeholder?: string;
    className?: string;
