...
export declare const KUMO_TABLE_OF_CONTENTS_VARIANTS: {
    readonly state: {
        readonly default: {
            readonly classes: "text-kumo-subtle hover:bg-kumo-tint hover:text-kumo-default hover:font-medium";
            readonly description: "Inactive section link";
        };
        readonly active: {
            readonly classes: "text-kumo-default font-medium";
...
export interface TableOfContentsGroupProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "title"> {
...
export declare const TableOfContents: import('react').ForwardRefExoticComponent<TableOfContentsProps & import('react').RefAttributes<HTMLElement>> & {
    ...
    List: import('react').ForwardRefExoticComponent<TableOfContentsListProps & import('react').RefAttributes<HTMLDivElement>>;
    Item: import('react').ForwardRefExoticComponent<TableOfContentsItemProps & import('react').RefAttributes<HTMLAnchorElement>>;
    Group: import('react').ForwardRefExoticComponent<TableOfContentsGroupProps & import('react').RefAttributes<HTMLDivElement>>;
};
