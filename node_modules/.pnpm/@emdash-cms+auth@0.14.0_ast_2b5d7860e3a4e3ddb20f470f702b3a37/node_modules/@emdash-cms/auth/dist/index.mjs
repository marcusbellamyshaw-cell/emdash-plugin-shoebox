...
import { S as validateScopes, _ as generateTokenWithHash, a as generateRegistrationOptions, b as hashToken, c as TOKEN_PREFIXES, d as decrypt, f as encrypt, g as generateToken, h as generateSessionId, i as verifyAuthenticationResponse, l as VALID_SCOPES, m as generatePrefixedToken, n as authenticateWithPasskey, o as registerPasskey, p as generateAuthSecret, r as generateAuthenticationOptions, s as verifyRegistrationResponse, t as PasskeyAuthenticationError, u as computeS256Challenge, v as hasScope, x as secureCompare, y as hashPrefixedToken } from "./authenticate-BiDGbUVY.mjs";
...
async function handleOAuthCallback(config, adapter, providerName, code, state, stateStore) {
	...
	const provider = getProvider(providerName);
	return findOrCreateOAuthUser(adapter, providerName, await fetchProfile(provider, (await exchangeCode(provider, providerConfig, code, storedState.redirectUri, storedState.codeVerifier)).accessToken, providerName), config.canSelfSignup);
}
/**
